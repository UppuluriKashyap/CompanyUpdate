    ...
    public class CompanyTINUpdate
    {
            ...
            string userName, string password)
        {
            using (var request = CreateCompanyTINUpdateRequest(url, userName, password, companyModel))
            {
                ...
                updatedCompany = JsonConvert.DeserializeObject<CompanyModel>(result);
        ...
        public static void Main(string[] args)
        {
            ...
            foreach (var company in companies)
            {
                ...
                var companyModel = callCompanyUpdate(companyUpdate, url, userName, password).Result;
                Console.WriteLine(companyModel.taxpayerIdNumber);
            }
        }
    }
}
